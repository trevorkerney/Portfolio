...
const quotes: [string, string][] = [
  ...
  ['Mentally, the guy\'s a disaster. He\'s gone off the rails over this thing with his wife. My opinion, he\'s not coming back. Not on his own.', 'Mike Ehrmantraut, Breaking Bad, season 3'],
  ['I\'ll be damned.', 'Django, Django Unchained'],
  ['They call that One-Eyed Charley.', 'Django, Django Unchained'],
  ['Quite spectaularly so.', 'Dr. King Schultz, Django Unchained'],
  ['Well gentleman, you had my curiosity. Now you have my attention.', 'Calvin Candie, Django Unchained'],
